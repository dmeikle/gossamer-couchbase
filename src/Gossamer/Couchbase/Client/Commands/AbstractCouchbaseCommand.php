...
use Gossamer\Couchbase\Documents\CouchbaseInterface;
...
class AbstractCouchbaseCommand extends AbstractCommand
{
    ...
    public function __construct(CouchbaseInterface $entity, HTTPRequest &$request, $credentials = null, GossamerDBConnection $connection = null)
    {
